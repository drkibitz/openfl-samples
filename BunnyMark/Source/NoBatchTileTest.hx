 ...
 */
class NoBatchTileTest extends Sprite
{
	var tf:TextField;
	var numBunnies:Int;
	var incBunnies:Int;
	...
	public function new()
	{
		...
		bunnyAsset = Assets.getBitmapData("images/wabbit_alpha.png");
		pirate = new Bitmap(Assets.getBitmapData("images/pirate.png"), PixelSnapping.AUTO, true);
